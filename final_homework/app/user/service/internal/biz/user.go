...
func (uc *UserUseCase) UserById(cxt context.Context, id int64) (*User, error) {
	return uc.repo.UserById(cxt, id)
}

func (uc *UserUseCase) CheckPassword(ctx context.Context, phone, password string) (bool, error) {
	return uc.repo.CheckPassword(ctx, phone, password)
}
