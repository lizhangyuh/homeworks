...
type UserClient interface {
	...
	GetUserById(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*UserInfoReply, error)
...
func (c *userClient) GetUserById(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*UserInfoReply, error) {
	out := new(UserInfoReply)
...
type UserServer interface {
	...
	GetUserById(context.Context, *IdRequest) (*UserInfoReply, error)
...
func (UnimplementedUserServer) GetUserById(context.Context, *IdRequest) (*UserInfoReply, error) {
